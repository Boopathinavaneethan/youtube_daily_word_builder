...
for filename in os.listdir(images_folder):
    if filename.endswith(('.png', '.jpg', '.jpeg')):
        ...
        blank_image_question.paste(logo, logo_position, logo)  # Paste with transparency support (if PNG)
        ...
        answer_position = ((blank_image_size[0] - answer_width) // 2, position[1] + img.size[1] + 30)  # Position below the image
        ...
        blank_image_answer.paste(logo, logo_position, logo)
